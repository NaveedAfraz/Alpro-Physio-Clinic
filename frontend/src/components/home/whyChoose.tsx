import { CheckCircle, Users, Award, Heart, Stethoscope, Globe, ChevronDown } from "lucide-react";
...
const WhyChoose = () => {
  ...
  const reasons: { icon: LucideIcon; title: string; description: string; color: string; bgColor: string }[] = [
    {
      icon: Users,
      title: "Experienced & Certified Therapists",
      description: "Our team of highly qualified physiotherapists brings years of expertise and advanced certifications to provide you with the best care possible.",
      color: "text-[#0044A3]",
      bgColor: "bg-[#EBF5FF]"
    },
    {
      ...
      description: "State-of-the-art facilities with the latest physiotherapy equipment and modern treatment rooms designed for optimal patient comfort.",
      color: "text-[#008D7D]",
      bgColor: "bg-[#E6F7F5]"
    },
    {
      ...
      description: "Comprehensive treatment approach combining traditional physiotherapy with cupping therapy and Pilates for complete wellness.",
      color: "text-[#D97706]",
      bgColor: "bg-[#FEF6E6]"
    },
    {
      ...
      description: "Personalized treatment plans with regular progress monitoring and adjustments based on your specific needs and recovery goals.",
      color: "text-[#5492DD]",
      bgColor: "bg-[#EFF6FF]"
    },
    {
      ...
      description: "Serving a diverse community including local families, professional athletes, and patients from around the world seeking quality care.",
      color: "text-[#7C3AED]",
      bgColor: "bg-[#F5F3FF]"
    },
  ];
  ...
  return (
    <motion.section 
        id="why-choose" 
        className="py-24 bg-gradient-to-b from-[#F9FAFB] to-white overflow-hidden"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
                ...
                <Users className="absolute -bottom-16 -right-16 w-80 h-80 text-white/10" />
                 <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: "url('https://placehold.co/800x1200/0044A3/FFFFFF?text=Alpro+Clinic')"}}></div>
                 <div className="absolute inset-0 bg-black/20"></div>
                 <div className="relative z-10 p-10 flex flex-col justify-end h-full text-white">
                    <h3 className="text-3xl font-bold font-acumin mb-4">A Commitment to Excellence</h3>
                    <p className="text-lg text-white/90 font-opensans">Your health is our highest priority. We are dedicated to providing care that is not only effective but also compassionate and respectful.</p>
                 </div>
            </motion.div>
            ...
            <motion.div className="flex flex-col gap-4" variants={sectionVariants}>
                {reasons.map((reason, index) => (
                    <motion.div key={index} variants={fadeInUp}>
                        <motion.header
                            initial={false}
                            animate={{ backgroundColor: index === expanded ? '#fff' : '#F9FAFB' }}
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className={`w-12 h-12 ${reason.bgColor} ${reason.color} rounded-lg flex items-center justify-center shrink-0`}>
             ...
             <div className="relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-lg text-white/90 font-opensans max-w-3xl mx-auto">
                        A complete ecosystem of care designed for your optimal recovery and long-term wellness.
                    </p>
                </div>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6 mb-10 font-opensans">
                  {[
                    "Free Initial Consultation", "Personalized Treatment Plans", "Advanced Diagnostic Assessment",
                    "Modern Equipment & Facilities", "Certified & Experienced Staff", "Progress Tracking & Monitoring",
                  ].map((benefit) => (

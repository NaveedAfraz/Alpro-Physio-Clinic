  ...
  const testimonials = [
    {
      ...
      rating: 5,
      testimonial:
        "After 6 months of chronic back pain, Alpro's rehabilitation program gave me back my mobility in just 3 weeks. The personalized care and modern equipment made all the difference.",
    ...
    },
    {
      ...
      rating: 5,
      testimonial:
        "As a professional athlete, I needed the best care for my knee injury. Alpro's sports physiotherapy program not only healed my injury but made me stronger than before.",
    ...
    },
    {
      ...
      rating: 5,
      testimonial:
        "The post-operative physiotherapy at Alpro was exceptional. Their evidence-based approach and caring staff made my recovery smooth and successful.",
    ...
    },
    {
      ...
      rating: 5,
      testimonial:
        "Best physiotherapy clinic in Shivpuri - professional, caring, and globally trusted. The combination therapy approach gave me relief I hadn't felt in years.",
  ...
  const renderStars = (rating: number) => {
    return Array.from({ length: 5 }, (_, i) => (
      <Star
        key={i}
        className={`w-5 h-5 ${
          i < rating ? "text-[#FFB800] fill-[#FFB800]" : "text-gray-300"
        }`}
      />
    ));
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <motion.div className="text-center mb-20" variants={fadeInUp}>
          ...
          <p className="text-lg text-[#1C1D0E]/80 max-w-3xl mx-auto font-opensans leading-relaxed">
            Real stories from patients who found healing and restored their
            quality of life with Alpro Physio Clinic.
          </p>
        </motion.div>
          ...
          <div className="p-10 bg-white rounded-2xl border border-gray-200 shadow-xl max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-4xl lg:text-5xl font-acumin text-[#0044A3]">
                ...
                <div className="text-base text-[#1C1D0E]/80 font-opensans mt-2">
                  Patient Satisfaction
                </div>
              </div>
              <div className="text-4xl lg:text-5xl font-acumin text-[#008D7D]">
                <AnimatedStatistic to={1000} suffix="+" />
                <div className="text-base text-[#1C1D0E]/80 font-opensans mt-2">
                  Success Stories
                </div>
              </div>
